import{M as i}from"./index-BGZVogms.js";import{b as n,m as l}from"./solid-B0ppho7y.js";import"./web-C2CdMWpm.js";const c={title:"tasks",layout:"project",created:"2024-11-13",published:"2024-11-13",thumbnail:null,blurb:"Local-first, collaborative notes and tasks—built for offline reliability."};function t(r){const e={a:"a",br:"br",h2:"h2",hr:"hr",li:"li",p:"p",strong:"strong",ul:"ul",...i(),...r.components};return[n(e.p,{get children(){return[n(e.strong,{children:"Tasks"})," is a local-first, collaborative notes and tasks app built for reliability, offline resilience, and open collaboration. It’s designed for users who want full control over their data while still benefiting from modern real-time collaboration."]}}),`
...
`]}}),`
`]}}),`
`,n(e.h2,{children:"Architecture overview"}),`
`,n(e.ul,{get children(){return[`
...
`,n(e.p,{get children(){return["It’s an exploration of what practical, everyday software looks like when ",n(e.strong,{children:"local-first principles"})," are treated as a foundation rather than a feature."]}})]}function d(r={}){const{wrapper:e}={...i(),...r.components};return e?n(e,l(r,{get children(){return n(t,r)}})):t(r)}export{d as default,c as frontmatter};
