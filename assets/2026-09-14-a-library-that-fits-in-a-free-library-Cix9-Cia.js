...
`,n(r.p,{children:`What she had was a document full of copy and a clear sense of the thing.
What she needed was a website.`}),`
`,n(r.h2,{children:`Starting with the look, not the code`}),`
`,n(r.p,{children:`We started with a mood board. I pitched sketchy Japanese print against a
...
`,n(r.p,{children:`Then she handed me her draft copy and I started building.`}),`
`,n(r.h2,{children:`One pass, then a real conversation`}),`
`,n(r.p,{children:`Four or five days later we got on a video call and went through what I had.
...
`,n(r.p,{children:`We took notes on how the pages should point at each other, since somebody
...
`,n(r.p,{children:`That call turned one page into four. The how-to instructions living on the
...
permission.`}),`
`,n(r.p,{children:`None of that was in the original copy. It came out of looking at a real
page together and asking what was missing.`}),`
`,n(r.h2,{children:`What it does`}),`
`,n(r.p,{children:`The part that mattered most isn't visible from the front page: her whole
team runs the site themselves.`}),`
`,n(r.p,{children:`I walked them through creating GitHub accounts, and they each log into a
...
`,n(r.p,{children:`Events work the same way. They add one, it appears on the upcoming events
...
`,n(r.p,{children:`There's no login for visitors either. The site is static, the zines download
straight to your printer, and the people who made it can change it without
calling me.`})]}function a(r={}){let{wrapper:a}={...e(),...r.components};return a?n(a,t(r,{get children(){return n(i,r)}})):i(r)}export{a as default,r as frontmatter};